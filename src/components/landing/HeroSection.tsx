  ...
  return (
    <section id="hero" className="relative w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <video
          src="/vedios/73798-549555720_medium.mp4" // Corrected path
          autoPlay
          loop
          muted
          playsInline // Important for autoplay on mobile
          className="w-full h-full object-cover"
          poster="https://placehold.co/1200x800.png" // Poster image for loading/fallback
        />
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 flex flex-col items-center justify-center text-center min-h-[70vh] py-20 md:py-32 lg:py-40 xl:py-48">
        <div className="space-y-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <p className="mx-auto max-w-3xl text-lg text-foreground/80 md:text-xl animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
