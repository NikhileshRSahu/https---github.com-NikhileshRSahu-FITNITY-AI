...
export default function ProgressMotivationSection() {
  return (
    <section id="progress" className="py-20 md:py-28 lg:py-32 bg-background/5">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-16 items-center">
          <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <h2 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl text-foreground leading-tight">
            ...
            <ul className="space-y-4 text-foreground/90">
              <li className="flex items-center gap-4">
                <LineChart className="h-7 w-7 text-accent flex-shrink-0" />
                <span className="text-lg">Interactive performance dashboards</span>
              </li>
              <li className="flex items-center gap-4">
                <Award className="h-7 w-7 text-accent flex-shrink-0" />
                <span className="text-lg">Gamification with badges and streaks</span>
              </li>
              <li className="flex items-center gap-4">
                <Lightbulb className="h-7 w-7 text-accent flex-shrink-0" />
                <span className="text-lg">Personalized motivation and AI insights</span>
              </li>
            </ul>
          </div>
          <div 
