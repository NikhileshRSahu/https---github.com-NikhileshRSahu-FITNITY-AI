...
export default function ShopPage() {
  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-12 md:py-20 animate-fade-in-up">
      ...
      <section id="featured-products" className="mb-12 sm:mb-16 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
          {featuredProducts.map((product, index) => (
            <div key={product.id} className="animate-fade-in-up" style={{animationDelay: `${index * 0.1 + 0.3}s`}}>
      ...
      <section id="shop-by-category" className="mb-12 sm:mb-16 animate-fade-in-up" style={{animationDelay: '0.4s'}}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 sm:gap-4 md:gap-6">
          {categories.map((category, index) => (
            <Link
              ...
              className="block p-4 sm:p-6 glassmorphic-card rounded-lg text-center hover:shadow-accent/40 hover:-translate-y-1 transition-all duration-300 group animate-fade-in-up"
      ...
      <section id="ai-recommendations" className="text-center py-10 sm:py-12 border-t border-b border-border/20 my-12 sm:my-16 animate-fade-in-up" style={{animationDelay: '0.6s'}}>
