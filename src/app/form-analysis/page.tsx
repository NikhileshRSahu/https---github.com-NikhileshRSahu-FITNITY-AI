...
export default function FormAnalysisPage() {
  ...
  async function onSubmit(data: FormAnalysisValues) {
    ...
    // Check if video is ready to capture a frame
    ...
    const videoDataUri = canvas.toDataURL('image/jpeg'); // Using JPEG for smaller size
      ...
      <Card className="max-w-2xl mx-auto glassmorphic-card">
        <CardHeader>
          ...
          <CardDescription className="text-primary-foreground/80">
            Let our AI check your exercise form. Enter the exercise name and click analyze.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          {hasCameraPermission === null && (
             <Alert>
              ...
              <AlertDescription>
                Please wait while we access your camera. You may need to grant permission in your browser.
              </AlertDescription>
            </Alert>
          )}
      ...
      {analysisResult && (
        <Card className="max-w-2xl mx-auto mt-12 glassmorphic-card">
          ...
          <CardContent className="space-y-4">
            <div>
              <h4 className="font-semibold text-primary-foreground/90 mb-1">Feedback:</h4>
