      ...
      <Card className="max-w-2xl mx-auto glassmorphic-card">
        <CardHeader>
          <CardTitle className="text-3xl font-bold flex items-center">
            <Camera className="mr-3 h-8 w-8 text-primary dark:text-accent" /> Real-time Form Analysis
          </CardTitle>
        ...
        <CardContent className="space-y-6">
          <div className="aspect-video bg-background/20 rounded-md overflow-hidden border-2 border-primary/30 dark:border-accent/30 shadow-inner">
        ...
        <CardFooter>
            <Alert variant="default" className="border-primary/30 dark:border-accent/30 bg-primary/5 dark:bg-accent/5 text-primary/80 dark:text-accent-foreground/80 text-xs">
              <ShieldAlert className="h-4 w-4 text-primary dark:text-accent" />
              <AlertTitle className="text-sm font-medium text-primary dark:text-accent">Important Disclaimer</AlertTitle>
              <AlertDescription>
        ...
        <Card className="max-w-2xl mx-auto mt-12 glassmorphic-card result-card-animate">
          <CardHeader>
            <CardTitle className="text-2xl font-bold flex items-center">
              <FileText className="mr-3 h-7 w-7 text-primary dark:text-accent" /> 
